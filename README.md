...
Add example Vim configuration from here https://github.com/neoclide/coc.nvim:
...
## Download and install clangd server
...
Install powerline fonts as well:

```bash
sudo apt-get install fonts-powerline
```

Add to vimrc and install vim-airline plugin:
